...
# -*- coding: utf-8 -*-
"""
Plot 6-well Plate Trajectories
...
def plot_trajectory(featurefilepath,
                   ...
                   legend=True,
                   rotate=False,
                   img_shape=None, start_frame=0, end_frame=0,
                   **kwargs):
...
#        plt.axis('off')
        # plt.tight_layout()
        return fig
def plot_plate_trajectories(featurefilepath, saveDir=None, downsample=10, fov= False,start_frame=0, end_frame=0):
    ...
    for channel, ch_featfilepath in file_dict.items():
        ...
        if not fov:
            ...
            status, img = vid.read_frame(end_frame) #0
            img_shape = img.shape
        ...
        plot_trajectory(ch_featfilepath,
                       ...
                       legend=False,
                       rotate=rotate,
                       img_shape=img_shape, start_frame=start_frame, end_frame=end_frame)
...
if __name__ == "__main__":
    ...
    example_featuresN = Path("/Volumes/behavgenom$/John/data_exp_info/Candida/data/New_param_test_smaller_background_sub/Results/20240720/240720_ca_run1_20h_op50_20240720_085251.22956805/metadata_featuresN.hdf5")
    ...
    plot_plate_trajectories(args.input, saveDir=args.output, downsample=10, fov=False,start_frame=0, end_frame=530
                            )
